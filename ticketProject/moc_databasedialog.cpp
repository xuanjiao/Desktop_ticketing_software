...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DatabaseDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 36, 21)
    ...
    "DatabaseDialog\0on_OKButton_clicked\0\0"
...
const QMetaObject DatabaseDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DatabaseDialog.data,
      qt_meta_data_DatabaseDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DatabaseDialog.stringdata))
